...
fun buildA0() = AutomatonBuilder("Игровая машина", listOf("A0"))
    ...
    .automationEvent("a14", "A1", "Открыть монетоприемник") // #er-2
    ...
    .state(0, "Ожидание", listOf("z03", "z13", "z12", "a14"))
    .state(1, "Прием жетонов")
    .state(2, "Игра", listOf("a0"), nestedFsmIds = listOf("A2"))
    .state(3, "Ошибка")
    .state(4, "Выдача жетона")
// 0
    .transition(0, 1, "a11", listOf("y1=1"))
    .transition(0, 3, "a11", listOf("y1=2"), listOf("z02"))
// 1
    .transition(1, 0, "e02", listOf(), listOf("z02", "a02"))
    .transition(1, 2, "e01", listOf("y1=1"), listOf("a12"))
    .transition(1, 3, "a11", listOf("y1=2"), listOf("z02"))
// 2
...
// 3
    ...
    .transition(3, 0, "e02", listOf("y1=2"), listOf("a02"))
// 4
...
fun buildA1() = AutomatonBuilder("Монетоприемник", listOf("A1"))
    ...
    .automationEvent("a14", "A0", "Открыть монетоприемник")  // #er-2
